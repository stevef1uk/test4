...
//go:generate swagger generate server --target ../../test4 --name Simple --spec ../swagger.txt

func configureFlags(api *operations.SimpleAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.SimpleAPI) http.Handler {
